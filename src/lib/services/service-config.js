...
export const SERVICE_LAYERS = {
  d2d: {
    ...
    layers: [
      ...
      { id: 'settori',  label: 'Settori',        defaultOn: true,  available: true,  future: false, category: 'territory' },
      ...
      { id: 'civici',   label: 'Civici',         defaultOn: false, available: false, future: true,  category: 'points'    },
