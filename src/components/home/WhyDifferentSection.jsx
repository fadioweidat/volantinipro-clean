...
export default function WhyDifferentSection() {
  return (
    <section style={{ background: "#050a14", paddingTop: 120, paddingBottom: 120, paddingLeft: 28, paddingRight: 28, boxSizing: "border-box" }} aria-labelledby="why-different-title">
      <style>{`
        .why-diff-container {
          max-width: 1200px;
          margin: 0 auto;
