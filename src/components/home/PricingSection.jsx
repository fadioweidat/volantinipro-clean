    ...
    <section className="section" style={{ background: "#111827", paddingLeft: 28, paddingRight: 28, boxSizing: "border-box", borderTop: "1px solid rgba(148,163,184,0.18)" }}>
      <div style={{ maxWidth: 1100, margin: "0 auto" }}>
        <div style={{ textAlign: "center", marginBottom: 58 }}>
          <div style={{ fontFamily: F.sans, fontSize: 11, fontWeight: 800, letterSpacing: ".14em", textTransform: "uppercase", color: "#06B6D4", marginBottom: 16 }}>
          ...
          {plans.map((plan) => {
            ...
            return (
              <div
                ...
                style={{
                  borderRadius: 20,
                  background: isPrimary ? "#22304A" : "#182235",
                  border: isPrimary ? `2px solid #6366F1` : "1px solid rgba(148,163,184,0.18)",
                  padding: "34px 30px",
                  display: "flex",
                  flexDirection: "column",
                  position: "relative",
                  boxShadow: isPrimary ? "0 24px 64px rgba(99,102,241,0.22)" : "0 4px 24px rgba(0,0,0,0.2)",
                }}
              >
                {plan.badge && (
                  <div style={{ position: "absolute", top: -13, left: "50%", transform: "translateX(-50%)", padding: "4px 14px", borderRadius: 20, background: GRAD, fontFamily: F.sans, fontSize: 11, fontWeight: 900, color: "#fff", whiteSpace: "nowrap", letterSpacing: ".04em" }}>
                    {plan.badge}
                  </div>
                )}
                ...
                <div style={{ width: "100%", height: 1, background: "rgba(148,163,184,0.12)", margin: "22px 0" }} />
                ...
                <Button
                  ...
                  style={{
                    ...
                    fontSize: 14,
                    fontWeight: 900,
                    boxShadow: isPrimary ? "0 10px 28px rgba(99,102,241,0.3)" : "none",
                  }}
                >
                  {plan.cta}
                </Button>
