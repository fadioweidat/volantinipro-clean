...
const styles = {
  shell: {
    ...
    boxShadow:
      "0 34px 90px rgba(0, 0, 0, 0.5), 0 30px 60px -20px rgba(232, 87, 26, 0.15), inset 0 1px 0 rgba(255, 255, 255, 0.08)",
    color: "#f8fafc",
    fontFamily,
  },
  topbar: {
  ...
  if (type === "radius") {
    return (
      <svg width="22" height="22" viewBox="0 0 22 22" fill="none">
        ...
        <path d="M7 11.5l3 3 5-6" stroke={color} strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round" />
      </svg>
    );
  }
...
function MetricTile({ icon, color, value, label, valueColor }) {
  return (
    <div style={styles.metric}>
      ...
      <span>
        <p style={{ ...styles.metricValue, color: valueColor || "#f8fafc" }}>{value}</p>
