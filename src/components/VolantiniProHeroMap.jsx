    ...
    >
      ...
      >
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
          ...
          {!compact && (
            <Button variant="secondary" onClick={goGpsMonitor} style={headerOutlineButtonStyle}>
              Monitor GPS
            </Button>
          )}
          {!compact && (
      ...
      {compact && menuOpen && (
        <div style={mobileMenuStyle}>
          ...
          <button onClick={() => { setMenuOpen(false); goGpsMonitor(); }} style={{ ...mobileMenuItemStyle, color: C.orange }}>Monitor GPS</button>
