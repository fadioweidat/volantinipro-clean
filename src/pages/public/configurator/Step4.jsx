      ...
      paddingBottom: isMobile ? 96 : 0
        ...
        gap: 16
          ...
          <Step4ExtrasPanel
            ...
            isMobile={isMobile}
            svcCommercial={svcCommercial}
            eur={eur}
            urgencySurchargePctLabel={urgencySurchargePctLabel}
          ...
          <Step4TechnicalAnalysisPanel
            box={box}
            isQuick={isQuick}
            showTechPanel={showTechPanel}
            setShowTechPanel={setShowTechPanel}
            isMobile={isMobile}
            estimatedFamiliesForSummary={estimatedFamiliesForSummary}
            coverageForSummary={coverageForSummary}
            selectedZoneNames={selectedZoneNames}
            col={col}
            nonEmpty={nonEmpty}
            serviceSummaryConfig={serviceSummaryConfig}
            fieldCard={fieldCard}
            step4TerritoryPluralLabel={step4TerritoryPluralLabel}
      ...
      {/* ── SIDEBAR ── */}
        <div>
          ...
          gap: 0
            ...
            <Step4PricingSummaryPanel
              tLabel={tLabel}
              baseCost={baseCost}
              serviceExtras={serviceExtras}
              disc={disc}
              smartPairingDiscount={smartPairingDiscount}
              data={data}
              urgencySurchargePctLabel={urgencySurchargePctLabel}
              urgSurch={urgSurch}
              subDiscPct={subDiscPct}
            ...
            <Step4CampaignActionsPanel
              ...
              setReturnFromLogin={setReturnFromLogin}
              showLoginRequired={showLoginRequired}
              handleLoginRequiredNavigation={handleLoginRequiredNavigation}
              campaignSaveError={campaignSaveError}
              isQuick={isQuick}
              handleDownloadPdf={handleDownloadPdf}
              pdfBusy={pdfBusy}
              col={col}
              ...
              confirmSyncStatus={confirmSyncStatus}
              ...
              onBack={onBack}
              data={data}
              handleOpenSavedCampaign={handleOpenSavedCampaign}
            />
          </div>
        </div>
      </div>
