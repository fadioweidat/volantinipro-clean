...
export function Step2({
  ...
  const assistantContext = buildQuoteAssistantStep2Context(assistantSnapshot, data, {
    ...
    comune: selectedComuni?.[0]?.label || selectedComuni?.[0]?.name || canonicalCityName || data.cityName || data.comune,
    provincia: selectedComuni?.[0]?.provincia || selectedComuni?.[0]?.province || selectedComune?.provincia || selectedComune?.prov || data.provincia,
    localita: selectedComune?.localita || selectedComune?.frazione || selectedComuni?.[0]?.localita || data.localita || data.frazione,
    frazione: selectedComune?.localita || selectedComune?.frazione || selectedComuni?.[0]?.frazione || data.localita || data.frazione,
    ...
    zonesCount: step2TruthModel.zones?.selected ?? (selZones?.length || 1),
    ...
    priorityMode: allocationMode || "auto",
