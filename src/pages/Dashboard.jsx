      ...
      <header style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 40 }}>
        <div>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
            <span style={{ fontSize: 13, opacity: 0.6 }}>Area:</span>
            <span style={{ 
...
function CampaignRow({ campagna, onVedi }) {
  const serviceMeta = {
    d2d: { label: 'Door to Door', color: C.orange, bg: 'rgba(232,87,26,.1)' },
    h2h: { label: 'Hand to Hand', color: C.blue, bg: 'rgba(96,165,250,.1)' },
    b2b: { label: 'Business', color: C.purple, bg: 'rgba(167,139,250,.1)' }
  }
