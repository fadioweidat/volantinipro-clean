...
const app = fs.readFileSync(path.join(root, "src/pages/public/configurator/Step2.jsx"), "utf8");
...
assert.ok(app.indexOf("buildStep2TruthModel(") < app.indexOf("buildStep2ViewModel("), "Truth Model deve essere costruito prima del View Model");
...
const truthConstruction = app.slice(app.indexOf("buildStep2TruthModel("), app.indexOf("buildStep2ViewModel("));
