...
assert.doesNotMatch(gpsApi, /campaign_id:\s*campaignId[\s\S]{0,120}driver_id:/, 'frontend must not construct GPS point campaign/driver payload');
...
assert.doesNotMatch(page, /uploadProofPhoto|Foto prova|capture="environment"|Nominatim|react-leaflet|leaflet/, 'photo-proof/map/geocoding UI is out of scope');
