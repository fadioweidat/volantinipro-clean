...
drop policy if exists "waitlist_insert_public" on public.smart_pairing_waitlist;
create policy "waitlist_insert_public"
on public.smart_pairing_waitlist for insert
with check (true);

drop policy if exists "waitlist_select_own" on public.smart_pairing_waitlist;
...
drop policy if exists "tracking_select_campaign_owner" on public.tracking_gps;
...
drop policy if exists "zone_admin_read_authenticated" on public.zone_admin;
...
drop policy if exists "campaign_zones_select_campaign_owner" on public.campaign_zones;
...
drop policy if exists "campaign_zones_insert_campaign_owner" on public.campaign_zones;
...
drop policy if exists "campaign_zones_update_campaign_owner" on public.campaign_zones;
...
drop policy if exists "campaign_zones_delete_campaign_owner" on public.campaign_zones;
