...
.vp-s1-pill.active { border-color: #E8571A; background: rgba(232,87,26,0.12); color: #E8571A; }
.vp-s1-option-card { display: flex; align-items: center; gap: 12px; padding: 14px 16px; border-radius: 11px; cursor: pointer; border: 1px solid rgba(255,255,255,0.08); background: rgba(255,255,255,0.03); transition: all 0.2s ease; }
.vp-s1-option-card:hover { border-color: rgba(255,255,255,0.15); background: rgba(255,255,255,0.05); }
.vp-s1-option-card.active { border-color: #E8571A; background: rgba(232,87,26,0.08); }

.vp-s1-format-card { border-radius: 9px; padding: 11px; cursor: pointer; text-align: center; border: 1px solid rgba(255,255,255,0.08); background: rgba(255,255,255,0.03); transition: all 0.2s ease; }
.vp-s1-format-card:hover { border-color: rgba(255,255,255,0.15); }
.vp-s1-format-card.active { border-color: #E8571A; background: rgba(232,87,26,0.1); }

.vp-s1-plan-card { border-radius: 11px; padding: 16px 14px; cursor: pointer; border: 1px solid rgba(255,255,255,0.07); background: rgba(255,255,255,0.03); transition: all 0.2s ease; text-align: center; position: relative; }
.vp-s1-plan-card:hover { border-color: rgba(255,255,255,0.15); }
.vp-s1-plan-card.active { border-color: #E8571A; background: rgba(232,87,26,0.1); }
